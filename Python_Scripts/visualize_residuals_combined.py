...
def plot_histogram_residuals_combined(residual_mean, residual_std):
    ...
    ax.set_title(f"Combined Mean Residual Distribution across all subjects", fontsize=20)
    # ax.legend(fontsize=12)
    plt.savefig(EC_PLOTS / f"residual_plot_err_combined.png", bbox_inches='tight')
    plt.close()


if __name__=="__main__":
    ALL_SIDS_ECs_PATH = "/home/mostafiz/Downloads/MIMIC-get/all_residuals/residual_csv/*.csv"
    ...
    # # rep_residual = rep_residual_data.values.reshape((25,))
    # print(residual_mean)
    plot_histogram_residuals_combined(residual_mean, residual_std)
